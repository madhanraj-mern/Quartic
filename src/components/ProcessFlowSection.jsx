...
const ProcessFlowSection = ({ homepage }) => {
  // Use Strapi data with fallbacks
  const processData = homepage?.process || {};
  const title = processData.title || 'How MOM Becomes Intelligent';
  const subtitle = processData.subtitle || 'Quartic uses DataOps for real-time context to convert raw signals into decision intelligence across the enterprise.';
  const strapiSteps = processData.steps || [];
            ...
            <div className="col-xl-5">
              ...
              >
                <div className="sec_heading_holder">
                  <span className="tag_lightBlue lh-base tag-mb-20px">Our Process</span>
