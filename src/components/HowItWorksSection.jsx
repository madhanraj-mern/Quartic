...
const HowItWorksSection = ({ homepage }) => {
  ...
  const subtitle = howItWorksData.subtitle || 'AI in Manufacturing Needs Real-Time Context';
  ...
  // Debug logging
  console.log('HowItWorksSection - homepage:', homepage);
  console.log('HowItWorksSection - howItWorksData:', howItWorksData);
