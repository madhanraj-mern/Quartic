...
const ApplicationSection = ({ homepage }) => {
  // Fallback data when Strapi is not available
  const fallbackData = {
    title: "Applications",
    subtitle: "Transform Your Operations with Quartic",
    description: "Comprehensive suite of applications designed to transform your manufacturing operations.",
    applications: [
      {
  ...
  // Use Strapi data if available, otherwise use fallback - Fixed data access pattern
  const sectionData = homepage?.Application || fallbackData;
  const applications = sectionData.applications || fallbackData.applications;
  
  // Debug logging
  console.log('ApplicationSection - homepage:', homepage);
  console.log('ApplicationSection - sectionData:', sectionData);
  console.log('ApplicationSection - applications:', applications);
        ...
        <div className="row">
          <div className="col-12">
            <div className="sec_heading_wrap text-center mb-4">
              <span className="tag_lightBlue lh-base tag-mb-20px">{sectionData.title || "Applications"}</span>
              <motion.h2
                ...
                data-aos-delay="100"
              >
                {sectionData.subtitle || "Transform Your Operations with Quartic"}
              </motion.h2>
              {sectionData.description && (
                <motion.p
                  className="section_description mt-3"
