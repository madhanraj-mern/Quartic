...
import styles from './PDOptimizerCard.module.css';

const PDOptimizerCard = ({ animationType = 'fadeIn' }) => {
  ...
  return (
    <div className={styles.container}>
      <motion.div
        ref={cardRef}
        className={styles.pdOptimizerCard}
        ...
        >
          <div className={styles.iconContainer}>
            ...
            >
              ...
              <rect x="14" y="10" width="3" height="2" fill="currentColor"/>
          ...
          <h3 className={styles.title}>PD Optimizer</h3>
          ...
          <motion.p 
            ...
            animate={isVisible ? "visible" : "hidden"}
          >
            In-silico optimization for faster product scale-up.
          </motion.p>
          ...
          <motion.div 
            ...
            animate={isVisible ? "visible" : "hidden"}
          >
            <a href="/pd-optimizer" className={styles.link}>
              Learn More
              <svg 
                width="16" 
                height="16" 
...
export default PDOptimizerCard;
